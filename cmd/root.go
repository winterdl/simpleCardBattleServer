	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		lobby := &cardBattle.CardBattleServer{
			...
			RoomConfig: &cardBattle.RoomManagementConfig{
				...
				DefaultMaxDeploment:     int32(viper.GetInt("room.default_max_deploment")),
				DefaultEachPlayerHealth: int32(viper.GetInt("room.default_each_player_health")),
				...
				DefaultCashReward:       int32(viper.GetInt("room.default_cash_reward")),
				DefaultLevelReward:      int32(viper.GetInt("room.default_level_reward")),
			},
